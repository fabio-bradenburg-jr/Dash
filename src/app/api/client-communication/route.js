...
// GET /api/client-communication?from=YYYY-MM-DD&to=YYYY-MM-DD  (ou ?week_start=)
export async function GET(request) {
  try {
    ...
    let query = ctx.adminSupabase
      .from('client_communication_weeks')
...
// POST /api/client-communication  { client_id, week_start, day (1-5), marked, byName }
